...
public abstract class AbstractCosmosDocumentProcessor extends AbstractProcessor {
    ...
    static final PropertyDescriptor URI = new PropertyDescriptor.Builder()
        ...
        .description("CosmosURI, typically of the form: https://{databaseaccount}.documents.azure.com:443/. Note this host URL is for Cosmos DB with SQL API")
        .required(false)
    ...
    protected AzureCosmosDocumentConnectionService connectionService = null;

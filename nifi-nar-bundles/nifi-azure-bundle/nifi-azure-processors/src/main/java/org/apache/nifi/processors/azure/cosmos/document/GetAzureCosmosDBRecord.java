...
public class GetAzureCosmosDBRecord extends AbstractAzureCosmosDBProcessor {
    ...
    public static final PropertyDescriptor QUERY = new PropertyDescriptor.Builder()
        ...
        .description("The SQL select query to execute. "
                + "This should be a valid SQL select query to Azure Cosmos DB with core sql api.")
    ...
    public static final PropertyDescriptor MAX_RESPONSE_PAGE_SIZE = new PropertyDescriptor.Builder()
        ...
        .description("The maximum number of elements in a response page from Azure Cosmos DB")
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        logger = getLogger();
        logger.debug("inside GetAzureCosmosDBRecord.onTrigger");
        ...
        final CosmosPagedIterable<JsonNode> response = container != null
                ...
                : null;
        if (response == null) {
            logger.error("Fails to get CosmosPagedIterable<CosmosItemProperties>");
            return;
        }

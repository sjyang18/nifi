...
public class PutAzureCosmosDBDocumentTest extends MockTestBase {

    private PutAzureCosmosDBDocumentWithMock processor;

    @Before
    public void setUp() throws Exception {
        processor = new PutAzureCosmosDBDocumentWithMock();
    ...
    public void testOnTrigger() throws Exception {
        ...
        testRunner.run();
        testRunner.assertAllFlowFilesTransferred(PutAzureCosmosDBDocument.REL_SUCCESS, 1);
    }
...
class PutAzureCosmosDBDocumentWithMock extends PutAzureCosmosDBDocument {
